...
class _OffersClient implements OffersClient {
  ...
  Future<List<OfferExtended>> getOffersApiV1OffersGet({
    ...
    final _options = _setStreamType<List<OfferExtended>>(
    ...
    late List<OfferExtended> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => OfferExtended.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
